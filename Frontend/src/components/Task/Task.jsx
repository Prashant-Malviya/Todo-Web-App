    ...
    return (
        <div className='bg-slate-300 py-4 rounded-lg shadow-md flex items-center justify-center gap-2 mb-3'>
            ...
            <div className="task-info text-slate-900 text-sm w-10/12">
                ...
                <p className="task-type capitalize"><strong>Type: </strong>{task.type}</p> {/* Display the type */}
                <p className="task-dueDate"><strong>Due Date: </strong>{moment(task.dueDate).format('LL')}</p> {/* Display the due date */}
